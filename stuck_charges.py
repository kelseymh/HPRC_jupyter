...
print("stuck_charges.py starting...",flush=True)
from imports import *
...
##print("Using V16-00-00 samples",flush=True)
...
##print("Using G4CMP358 samples",flush=True)
...
print("Using noLimits samples",flush=True)
...
print("StepsVsFinalRZ('U')...",flush=True)
...
print("Fitting uniform field...",flush=True)
...
print("StepsVsVoltage w/curves...",flush=True)
...
print("Consolidated StepsVsVoltage",flush=True)
...
print("Consolidated StepsVsField",flush=True)
